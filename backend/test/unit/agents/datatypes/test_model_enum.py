...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("openrouter/z-ai/glm-5.3-flashx:nitro", "glm-5.3-flashx"),  # prefix + :nitro variant
        ("moonshotai/kimi-k3:nitro", "kimi-k3"),         # single prefix + variant
...
def test_bare_unwraps_litellm_model():
    ...
    assert _bare(LitellmModel("openrouter/z-ai/glm-5.3-flashx:nitro")) == "glm-5.3-flashx"
...
def test_nitro_variant_does_not_change_capabilities():
    ...
    plain = "openrouter/z-ai/glm-5.3-flashx"
    nitro = "openrouter/z-ai/glm-5.3-flashx:nitro"
...
def test_non_lineup_models_default_to_permissive_capabilities():
    ...
    glm = "openrouter/z-ai/glm-5.3-flashx:nitro"
